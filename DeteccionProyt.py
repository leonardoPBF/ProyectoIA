...
weights = "D:/Leonardo/Universidad/Ciclo-8/IA/Proy/Deteccion/modelo.pt" #modificar
...
while True:
    ...
    for det in results.xyxy[0]:  # [x1, y1, x2, y2, conf, cls]
        ...
        if conf > 0.7:
            ...
            if conf > 0.94:
                try:
                    # Configura el socket y envía el nombre de la clase
                    ...
                    print(f"Error al enviar datos al ESP32: {class_name}", e)
